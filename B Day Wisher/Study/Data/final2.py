...
def MailSender_Owner(filename):
	try:
		...
		body = """
		Hello Saurabh Sir
		Please Check below attached log file and that log file is about to whome script wishes today...
...
def Compare_dates():
	...
	today = date.today()
	log_path = os.path.join(folder_name,"Wish_on %s.log"%(today))
